...
@section('title','Business Plan Competition')
@section('css')
    @parent
    <style>
        .bg-kiri{
            background: linear-gradient(225.7deg, #3F0A3E 42.97%, #11354F 100.36%);
            min-height:80vh;
        }
    </style>
@endsection
@section('image_kiri',asset('img/business_plan_competition.png'))
                    ...
                    <div id="requirement-section">
                        ...
                        <div class="mx-lg-5 px-lg-5 mt-5">
                            <ul class="mt-5 mr-3 requirement-list">
                                ...
                                <li><h4 class="pl-3">Upload twibbon Business Plan Competition yang dapat diunduh di bawah ini.</h4></li>
                                <li><h4 class="pl-3">Pastikan akunmu tidak diprivate dan jangan lupa tag instagram @its_expo ya!</h4></li>
                            </ul>
                            <div class="row px-5 px-lg-0 mt-5 pt-5">
                                <a href="https://drive.google.com/drive/folders/1jN82CrcpwZLi-6zlV0n2D-CyouoZ41Nw" type="button" class="col-lg-3 mt-3 btn btn-primary badge-pill badge-primary p-3" style="background: #3F0A3E;font-weight:300;" target="_blank">Unduh Twibbon</a>
                                <button type="button" class="col-lg-3 mt-3 offset-lg-6 btn btn-primary badge-pill badge-primary p-3" style="background: #3F0A3E;font-weight:300;" onclick="showHideElement('#requirement-section','#registration-section')">Lanjut Daftar</button>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="mx-lg-5 px-lg-5 mt-5">
                            <div class="bs-stepper">
                                ...
                                <div id="success-part" class="content" role="tabpanel" aria-labelledby="success-part-trigger">
                                        ...
                                        text-align: center;">
                                            Terima kasih telah mendaftar Bussiness Plan Competiton ITS EXPO 2021. Silahkan menuju dahsboard untuk melanjutkan proses pelengkapan berkas.
                                        </h4>
                                        <div class="row px-5 px-lg-0 mt-5 pt-5">
