...
@section('title','Paper Competition')
@section('css')
    @parent
    <style>
        .bg-kiri{
                    ...
                    <div id="requirement-section">
                        ...
                        <div class="mx-lg-5 px-lg-5 mt-5">
                            <ul class="mt-5 mr-3 requirement-list">
                                ...
                                <li><h4 class="pl-3">Biaya pendaftaran Abstrak, Gratis</h4></li>
                    ...
                    <div id="registration-section" style="display: none">
                        ...
                        <div class="mx-lg-5 px-lg-5 mt-5">
                            <div class="bs-stepper">
                                ...
                                <form action="{{route('paper-competition.post')}}" method="POST">
                                    @csrf
                                ...
                                <div id="success-part" class="content" role="tabpanel" aria-labelledby="success-part-trigger">
                                        ...
                                        text-align: center;">
                                            Terima kasih telah mendaftar Paper Competition ITS EXPO 2021. Silahkan menuju dahsboard untuk melanjutkan proses pelengkapan berkas.
                                        </h4>
                                        <div class="row px-5 px-lg-0 mt-5 pt-5">
