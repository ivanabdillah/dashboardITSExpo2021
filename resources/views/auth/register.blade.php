...
<form action="{{ $register_url }}" method="post">
  ...
  <div class="input-group mb-3">
    <input type="text" name="college_name" class="form-control" placeholder="College" required>
    <div class="input-group-append">
      <div class="input-group-text">
  ...
  <div class="input-group mb-3">
    <select class="custom-select" name="competition_id" required>
      <option selected disabled>Competition</option>
      @foreach ($competitions as $_)
  ...
  <div class="input-group mb-3">
    <input type="text" name="leader_name" class="form-control" placeholder="Leader Name" required>
    <div class="input-group-append">
      <div class="input-group-text">
